...
export const COMMON_FOODS_CATALOG: FoodCatalogItem[] = [
  ...
  // ===================== QUICK STAPLES COMBO MEALS =====================
  {
    ...
    fat: 4,
    icon: '🍗',
    keywords: ['chicken rice', 'meal prep', 'staple', 'high protein'],
  },
  {
    id: 'food-staple-shake-banana',
    name: 'Whey Protein Shake & Banana',
    category: 'Staples',
    servingSize: '1 shake + 1 fruit',
    servingWeightG: 300,
    servingUnit: 'serving',
    calories: 225,
    protein: 26,
    ...
    fat: 2,
    icon: '🥛',
    keywords: ['post workout', 'shake', 'banana', 'staple'],
  },
  {
    id: 'food-staple-boiled-eggs-toast',
    name: '2 Boiled Eggs & Whole Wheat Toast',
    category: 'Staples',
    ...
    fat: 11,
    icon: '🍳',
    keywords: ['eggs toast', 'breakfast', 'staple'],
  },
  {
    ...
    fat: 1,
    icon: '🫐',
    keywords: ['greek yogurt', 'berries', 'snack', 'staple'],
  },
  {
    id: 'food-staple-salmon-sweet-potato',
    name: 'Salmon Fillet & Roasted Sweet Potato',
    category: 'Staples',
    servingSize: '1 dinner plate (300g)',
    servingWeightG: 300,
    servingUnit: 'serving',
    calories: 420,
    protein: 35,
    ...
    fat: 16,
    icon: '🐟',
    keywords: ['salmon', 'sweet potato', 'dinner', 'recovery'],
  },
  {
    id: 'food-staple-oats-peanut-butter',
    name: 'Oatmeal with Natural Peanut Butter',
    category: 'Staples',
    ...
    fat: 12,
    icon: '🥣',
    keywords: ['oats', 'peanut butter', 'breakfast', 'staple'],
  },
];
